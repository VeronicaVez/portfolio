...
const Projects = () => {
  return (
    <div className="projects" id="projects">
      <h2>Projects</h2>
      <div className="flex">
        <article className="projects-cards ecommerce">
          <h3>Hygge Lights - Work in Progress</h3>
          <p className="project-description">
            Developed a sleek and responsive e-commerce website for handmade soy
            candles, featuring a seamless shopping experience, and custom
            product pages showcasing the unique qualities of each artisanal
            creation.
          </p>
          <h5>
          ...
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/candlesEcommerce-client"
              target="_blank"
            >
              <svg
        ...
        <article className="projects-cards weather">
          ...
          <h5>JavaScript, React.js, Bootstrap, HTML, CSS</h5>
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/weather-app"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex">
        <article className="projects-cards game2">
          ...
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/rockpaperscissorslizardspock-game"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://rockpaperscissorslizardspock-game.netlify.app/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <article className="projects-cards travels">
          ...
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/mavetravels-client"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://mavetravels.netlify.app/" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
      ...
      <div className="flex">
        <article className="projects-cards books">
          ...
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/my-book-wishlist-client-project2"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://mybookwishlist.netlify.app/" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
        ...
        <article className="projects-cards game1">
          ...
          <div className="repo-demo">
            <a
              href="https://github.com/VeronicaVez/bricks-breaker-game-project1"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://blasdelezo1.github.io/brick-breaker-MVP/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
